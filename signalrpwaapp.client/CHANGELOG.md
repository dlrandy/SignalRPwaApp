...
- Create Angular project with ng: `ng new signalrpwaapp.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`signalrpwaapp.client.esproj`).
